...
class Main(Frame):
    ...
    def startUI(self):
        btn = Button(root, text="Камень", font=("Times New Artem", 15),
                     command=lambda x=1: self.btn_click(x))
        btn2 = Button(root, text="Ножницы", font=("Times New Artem", 15),
                      command=lambda x=2: self.btn_click(x))
        btn3 = Button(root, text="Бумага", font=("Times New Artem", 15),
        ...
        self.lbl = Label(root, text="Начало игры!", bg="#3AD656", font=("Times New Artem", 21, "bold"))
        self.lbl.place(x=150, y=25)

        self.win = self.drow = self.lose = 0

        self.lbl2 = Label(root, justify="left", font=("Times New Artem", 13),
